            ...
            <div class="card-body">
                ...
                <div class="row">
                    ...
                    <div class="form-group col-6 ">
                        ...
                        <select name="provinsi_id" id="province" style="width:100%!important" class="form-control select2-provinsi">
                    ...
                    <div class="form-group col-6 ">
                        ...
                        <select name="kabupaten_id" id="kabupaten" style="width:100%!important" class="form-control select2 select2-hidden-accessible select2-kabupaten">
                            <option value="">== Select Kabupaten ==</option>
                        </select>
                    </div>
                    <div class="form-group col-6 ">
                        {{ Form::label('Kecamatan', null, ['class' => 'control-label']) }}
                        <select name="kecamatan_id" id="kecamatan" style="width:100%!important" class="form-control  select2-kecamatan">
                    ...
                    <div class="form-group col-6 ">
                        ...
                        <select name="kelurahan_id" id="kelurahan" style="width:100%!important" class="form-control select2-kelurahan">
                            <option value="">== Select Kelurahan ==</option>
                        </select>
                    </div>
                    <div class="form-group col-6 ">
                        {{ Form::label('tipe', null, ['class' => 'control-label']) }}
                        <select name="tipe" id="tipe" style="width:100%!important" class="form-control ">
