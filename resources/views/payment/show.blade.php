                        ...
                        <div class="box-body">
                            <div class="row">
                                ...
                                <div class="form-group col-6">
                                    ...
                                    {{ Form::text('name', $data->userdetail->name, array_merge(['class' => 'form-control','require'=>true,'readonly'=>true])) }}
                                    <!-- /.input group -->
                                </div>
                                <div class="form-group col-6 ">
                                ...
                                <div class="form-group col-6">
                                    ...
                                    <textarea name="desc" class="form-control desc">{{$data->note}}</textarea>
                                </div>
                            </div>
                            <hr>
