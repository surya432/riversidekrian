...
<form action="{{ $register_url }}" method="post">
    ...
    {{-- Email field --}}
    <div class="input-group mb-3">
        <input type="text" name="alamat" class="form-control {{ $errors->has('alamat') ? 'is-invalid' : '' }}" value="{{ old('alamat') }}" placeholder="alamat saat ini">
        <div class="input-group-append">
            <div class="input-group-text">
                <span class="fas fa-location {{ config('adminlte.classes_auth_icon', '') }}"></span>
            </div>
        </div>
