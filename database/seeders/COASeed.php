...
class COASeed extends Seeder
{
    ...
    public function run()
    {
        ...
        $data = array(
            ...
            array("code" => 10104, "desc" => "UANG MUKA", "debet_credit" => "debet", "grup" => "ASSET"),
            ...
            array("code" => 40101, "desc" => "PENDAPATAN IURAN RUTIN BULANAN", "debet_credit" => "credit", "grup" => "REVENUE"),
            ...
            array("code" => 70308, "desc" => "BIAYA KONSUMSI", "debet_credit" => "debet", "grup" => "EXPENSE"),
            ...
            array("code" => 70311, "desc" => "BIAYA SEWA", "debet_credit" => "debet", "grup" => "EXPENSE"),
            array("code" => 70312, "desc" => "BIAYA ASURANSI", "debet_credit" => "debet", "grup" => "EXPENSE"),
            array("code" => 70313, "desc" => "BIAYA KONSULTAN", "debet_credit" => "debet", "grup" => "EXPENSE"),
